  ...
  mods.forEach((m) => {
    switch (m) {
      ...
      case "caps":
        ...
        break;
      case "a":
        value = vowels.includes(value[0]) ? `an ${value}` : `a ${value}`;
        break;
      case "ed":
      ...
      case "ing":
        ...
        break;
      case "s":
        if (value.endsWith("es")) value = value;
        else if (value.endsWith("s")) value = `${value}es`;
        else if (
          value.endsWith("y") &&
        ...
        break;
      case "possessive":
        if (value.endsWith("s")) value = `${value}'`;
        else value = `${value}'s`;
        break;
      case "range":
